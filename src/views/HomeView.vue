<template>
  <section class="h-dvh">
    ...
    <div
      class="body flex flex-row justify-center items-center gap-4 !px-4 h-full"
    >
      <div
        class="lg:!h-[650px] w-full max-w-[40dvw] md:!h-[450px] xl:!h-[800px]"
      >
        <img
        ...
        <div class="flex flex-col">
          ...
          <div class="flex flex-col">
            ...
            <div class="beyond_box !text-charcoal relative">
              <span
                class="uppercase !text-[3em] !font-bold !italic !font-josefin"
                >Beyond The
              </span>
            </div>
