...
const filledColors = {
  login:
    "bg-violet-500 text-background dark:text-zinc-900 hover:bg-violet-600 hover:translate-1 shadow-[4px_4px_16px_rgba(139,92,246,0.5)] active:text-gray-400 active:translate-0",
  forms:
...
const outlineColors = {
  login:
    "border border-violet-600 text-violet-600 hover:bg-violet-500/20 hover:translate-1 active:translate-0 active:text-login-hg-50",
